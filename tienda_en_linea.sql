...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-03-2023 a las 02:50:01
...
--
-- Estructura de tabla para la tabla `tienda en linea`
--

CREATE TABLE `tienda en linea` (
  `id` int(11) NOT NULL,
...
--
-- Indices de la tabla `tienda en linea`
--
ALTER TABLE `tienda en linea`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `tienda en linea`
--
ALTER TABLE `tienda en linea`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
